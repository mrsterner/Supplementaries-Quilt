...
public class FramedSignPost {
    public static final BlockState framedFence = FBContent.blockFramedFence.get().getDefaultState ();
    ...
    public static boolean handleInteraction(SignPostBlockTile te, Player player, Hand hand, ItemStack stack, World world, BlockPos pos) {
    ...
    protected static boolean isValidBlock(BlockState state, Player player, World level, BlockPos pos) {
