...
public class PresentBlockTile extends OpeneableContainerBlockEntity implements IColored, IDynamicContainer {
    ...
    public static boolean isPacked(ItemStack stack) {
        ...
        if (com != null) {
            NbtCompound nbt = com.getCompound("BlockEntityTag");
    ...
    public boolean isPacked() {
        return this.getBlockState().get(PresentBlock.PACKED);
    }
    ...
    public void updateState(boolean shouldPack, String newRecipient, String sender, String description) {
        ...
        if (!this.level.isClient() && this.isPacked() != shouldPack) {
            if (shouldPack) {
            ...
            this.level.setBlockState(this.getBlockPos(), this.getBlockState().with(PresentBlock.PACKED, shouldPack), 3);
        }
    }
