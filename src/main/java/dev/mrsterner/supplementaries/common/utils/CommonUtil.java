...
public class CommonUtil {
    ...
    public static boolean isLanternBlock(Block b) {
        ...
        if (b instanceof LanternBlock) {
            return !b.getDefaultState ().hasBlockEntity() || b instanceof LightableLanternBlock;
        }
        return false;
    }
    ...
    private static final ShulkerBoxBlockEntity SHULKER_TILE = new ShulkerBoxBlockEntity(BlockPos.ZERO, Blocks.SHULKER_BOX.getDefaultState ());
    ...
    public static HitResult rayTrace(LivingEntity entity, World world, ClipContext.Block blockMode, ClipContext.Fluid fluidMode) {
        return rayTrace(entity, world, blockMode, fluidMode, entity.getAttribute(ForgeMod.REACH_DISTANCE.get()).get());
    }

    public static HitResult rayTrace(Entity entity, World world, ClipContext.Block blockMode, ClipContext.Fluid fluidMode, double range) {
    ...
    public static Player getEntityStand(Entity copyPosFrom, Entity copyRotFrom){
        World level = copyPosFrom.getWorld();
        Player p;
