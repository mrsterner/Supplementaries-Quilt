...
public class LabelEntity extends HangingEntity {
    ...
    public LabelEntity(PlayMessages.SpawnEntity spawnEntity, World world) {
        this(world);
    }

    public LabelEntity(World level, BlockPos pos, Direction direction) {
    ...
    public void addAdditionalSaveData(NbtCompound tag) {
        ...
        if (!this.getItem().isEmpty()) {
            tag.put("Item", this.getItem().save(new NbtCompound()));
        }
    ...
    public void readAdditionalSaveData(NbtCompound tag) {
        ...
        NbtCompound compound = tag.getCompound("Item");
        if (!compound.isEmpty()) {
    ...
    public ActionResult interact(Player pPlayer, Hand pHand) {
        ...
        if (!itemstack.isEmpty() && !this.isRemoved()) {
            ...
            return ActionResult.success(pPlayer.level.isClient());
        }
