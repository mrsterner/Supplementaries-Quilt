...
public class EatFodderGoal extends MoveToBlockGoal {
    ...
    private static final BlockState FODDER_STATE = ModRegistry.FODDER.get().getDefaultState ();
    ...
    public void tick() {
        ...
        if (this.isReachedTarget()) {
            ...
            if (this.ticksSinceReachedGoal > 0) {
                ...
                if (!world.isClient() && ticksSinceReachedGoal % 2 == 0) {
            ...
            if (this.ticksSinceReachedGoal > this.blockBreakingTime) {
                ...
                if(state.is(ModRegistry.FODDER.get())) {
                    ...
                    if (layers > 1) {
                        world.syncWorldEvent(2001, targetPos, Block.getId(FODDER_STATE));
                        world.setBlockState(targetPos, FODDER_STATE.with(FodderBlock.LAYERS, layers - 1), 2);
                    } else {
