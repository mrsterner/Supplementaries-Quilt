...
//import net.minecraft.world.level.ServerWorldAccess;
...
//
//    public FireflyEntity(EntityType<? extends PathfinderMob> type, World world) {
//        super(type, world);
//        xpReward = 1;
//        setNoAi(false);
...
//
//    @Nullable
//    public SpawnGroupData finalizeSpawn(ServerWorldAccess world, DifficultyInstance difficulty, MobSpawnType spawnReason, @Nullable SpawnGroupData data, @Nullable NbtCompound compound) {
...
//
//    @Override
//    protected PathNavigation createNavigation(World worldIn) {
...
//
//
//    public static boolean canSpawnOn(EntityType<? extends Mob> firefly, WorldAccess worldIn, MobSpawnType reason, BlockPos pos, Random random) {
...
//
//    @Override
//    public boolean checkSpawnRules(WorldAccess world, MobSpawnType spawnReasonIn) {
...
//        return ForgeRegistries.SOUND_EVENTS.get(new ResourceLocation("entity.bat.hurt"));
//    }
//
//    @Override
//    public net.minecraft.sounds.SoundEvent getDeathSound() {
//        return ForgeRegistries.SOUND_EVENTS.get(new ResourceLocation("entity.bat.death"));
//    }
//
...
//        if (this.alpha == 0f && !this.level.isClient()) {
//
