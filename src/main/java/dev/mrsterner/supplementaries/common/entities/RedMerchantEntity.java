...
public class RedMerchantEntity extends AbstractVillager implements RangedAttackMob {
    ...
    @Override
    public ActionResult mobInteract(Player player, Hand hand) {
    ...
    @Override
    public void addAdditionalSaveData(NbtCompound p_213281_1_) {
    ...
    @Override
    public void readAdditionalSaveData(NbtCompound p_70037_1_) {
