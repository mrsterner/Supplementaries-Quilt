...
public class DefaultCatchableMobCap<T extends Entity> extends BaseCatchableMobCap<T> {
    ...
    @Override
    public void tickInsideContainer(World world, BlockPos pos, float mobScale, NbtCompound tag) {
        if (world.isClient()) {
    ...
    public static <E extends Entity> ICatchableMob getDefaultCap(E e) {
        if (e.level.isClient() && e instanceof LivingEntity && ClientConfigs.block.TICKLE_MOBS.get()
