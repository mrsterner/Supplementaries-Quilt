...
public class RedMerchantContainerMenu extends AbstractContainerMenu {
    ...
    private void playTradeSound() {
        if (!this.trader.isClient()()) {
            ...
            entity.getWorld().playLocalSound(entity.getX(), entity.getY(), entity.getZ(), this.trader.getNotifyTradeSound(), SoundSource.NEUTRAL, 1.0F, 1.0F, false);
        }
