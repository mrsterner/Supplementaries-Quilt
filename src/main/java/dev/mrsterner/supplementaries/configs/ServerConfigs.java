...
public class ServerConfigs {
    ...
    public static class item {
        ...
        private static void init(ForgeConfigSpec.Builder builder) {
            ...
            SLINGSHOT_RANGE = builder.comment("Slingshot range multiplier. Affect the initial ProjectileEntity speed")
    ...
    public static class cached {
        ...
        public static void refresh() {
            ...
            ROPE_ARROW_BLOCK = ForgeRegistries.BLOCKS.get(new ResourceLocation(ROPE_ARROW_ROPE));
