        ...
        if (state != null) {
            try {
                ...
                if (mimic == null || (mimic.isAir())) {
                    BakedModel model = blockModelShaper.getBlockModel(state.with(FrameBlock.HAS_BLOCK, false));
            ...
            //IBakedModel overlay = Minecraft.getInstance().getBlockRenderer().getBlockModelShaper().getBlockModel(state.with(FrameBlock.TILE,2));
            try {
