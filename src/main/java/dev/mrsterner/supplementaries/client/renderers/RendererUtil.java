...
public class RendererUtil {
    ...
    public static void renderBlockState(BlockState state, PoseStack matrixStack, MultiBufferSource buffer,
                                        BlockRenderDispatcher blockRenderer, World world, BlockPos pos) {
        try {
    ...
    public static void renderBlockState(BlockState state, PoseStack matrixStack, MultiBufferSource buffer,
                                        BlockRenderDispatcher blockRenderer, World world, BlockPos pos, RenderType type) {
    ...
    public static void renderBubble(VertexConsumer builder, PoseStack matrixStackIn, float w,
                                    ...
                                    boolean flippedY, BlockPos pos, World level, float partialTicks) {
        int lu = combinedLightIn & '\uffff';
        ...
        // w = (1-MathHelper.sin((float) (time*Math.PI*2)));
        ...
        float unw = amp * MathHelper.cos(((float) Math.PI * 2F) * (time + 0));
        float une = amp * MathHelper.cos(((float) Math.PI * 2F) * (time + 0.25f));
        float use = amp * MathHelper.cos(((float) Math.PI * 2F) * (time + 0.5f));
        float usw = amp * MathHelper.cos(((float) Math.PI * 2F) * (time + 0.75f));
    ...
    public static void rotateVerticesY(int[] v, TextureAtlasSprite sprite, BlockRotation rot) {
