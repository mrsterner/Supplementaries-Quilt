...
public class GlobeTextureManager {
    ...
    public static RenderType getRenderType(World world, boolean sepia) {
        return getTextureInstance(world, sepia).renderType;
    }

    private static TextureInstance getTextureInstance(World world, boolean sepia) {
        return TEXTURE_CACHE.computeIfAbsent(getTextureId(world, sepia),
                (i) -> new TextureInstance(world, sepia));
    }

    private static String getTextureId(World level, boolean sepia) {
    ...
    private static class TextureInstance implements AutoCloseable {
        ...
        private TextureInstance(World world, boolean sepia) {
            this.sepia = sepia;
