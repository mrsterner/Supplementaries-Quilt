...
public class TextUtil {
    ...
    static {
        ...
        float lx = 1 - (2 * 0.125f);
        CREDITS.addAll(Minecraft.getInstance().font.split(parseText(c), MathHelper.floor(lx * SCALINGFACTOR)));
        String b = """
                THE BEE MOVIE\u00A7r
        ...
        BEE_MOVIE.addAll(Minecraft.getInstance().font.split(parseText(b), MathHelper.floor(lx * SCALINGFACTOR)));
    }
