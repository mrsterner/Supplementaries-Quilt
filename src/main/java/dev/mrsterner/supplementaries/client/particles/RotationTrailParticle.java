...
public class RotationTrailParticle extends SimpleAnimatedParticle {
    ...
    private RotationTrailParticle(ClientWorld clientWorld, double x, double y, double z, Vec3 center, Vec3 rotationAxis,
    ...
    public void move(double x, double y, double z) {
        ...
        Vec3 newPos = MathHelperUtils.changeBasisN(this.axis, rot).add(this.origin);
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientWorld world,
            ...
            Vec3 axis = MathHelperUtils.V3itoV3(dir.getNormal());

            Vec3 rot = new Vec3(radius, 0, 0).yRot(radAngle);
            Vec3 newPos = MathHelperUtils.changeBasisN(axis, rot).add(center);
