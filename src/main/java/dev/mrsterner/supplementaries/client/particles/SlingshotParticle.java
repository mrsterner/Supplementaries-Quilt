...
public class SlingshotParticle extends TextureSheetParticle {
    ...
    private SlingshotParticle(ClientWorld world, double x, double y, double z, double motionX, double motionY, double motionZ, SpriteSet sprites) {
        super(world, x, y, z);
    ...
    public void tick() {
        ...
        final float a = MathHelperUtils.PHI;
        this.alpha = a + 1 / (x - a);
    }
