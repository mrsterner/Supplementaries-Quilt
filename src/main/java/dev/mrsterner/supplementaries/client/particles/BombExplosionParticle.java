...
public class BombExplosionParticle extends TextureSheetParticle {
    ...
    private BombExplosionParticle(ClientWorld world, double x, double y, double z, double scale, SpriteSet spriteWithAge) {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed,
                                     double zSpeed) {
