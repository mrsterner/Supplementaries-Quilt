...
public class StasisParticle extends SimpleAnimatedParticle {
    private StasisParticle(ClientWorld world, double x, double y, double z, double motionX, double motionY, double motionZ, SpriteSet sprite) {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType type, ClientWorld world, double x, double y, double z, double motionX, double motionY, double motionZ) {
