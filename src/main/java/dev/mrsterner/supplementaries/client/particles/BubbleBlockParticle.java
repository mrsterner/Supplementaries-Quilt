...
public class BubbleBlockParticle extends TextureSheetParticle {
    ...
    public BubbleBlockParticle(ClientWorld pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed, SpriteSet pSprites) {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        @Nullable
        @Override
        public Particle createParticle(SimpleParticleType pType, ClientWorld pLevel, double pX, double pY, double pZ,
